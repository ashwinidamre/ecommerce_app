...
class MensWidget extends StatefulWidget {
  const MensWidget({Key? key});

  @override
  State<MensWidget> createState() => _MensWidgetState();
}
...
class _MensWidgetState extends State<MensWidget> {
  ...
  Future<void> fetchImageUrls() async {
    final apiUrl =
        "http://192.168.251.76/projects/api_shoppingapp/category_men.php";
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          imageUrls = responseData
              .map<String>((data) =>
                  "http://192.168.251.76/projects/api_shoppingapp/assets/mens/${data['cat_img']}")
              .toList();

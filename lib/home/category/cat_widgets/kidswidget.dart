...
class Kids_widgets extends StatefulWidget {
  const Kids_widgets({super.key});

  @override
  State<Kids_widgets> createState() => _Kids_widgetsState();
}

class _Kids_widgetsState extends State<Kids_widgets> {
  ...
  Future<void> fetchImageUrls() async {
    const apiUrl =
        "http://192.168.251.76/projects/api_shoppingapp/category_kids.php";
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          imageUrls = responseData
              .map<String>((data) =>
                  "http://192.168.251.76/projects/api_shoppingapp/assets/kids/${data['cat_img']}")
              .toList();
